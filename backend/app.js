...
let Todo = require('./todo_spoon.model');
    ...
    if (request.method === 'OPTIONS') {
      ...
      Todo.findById(id, function(err, todo) {
        if (!todo) {
          ...
          todo.todo_importance = req.todo_importance;
          todo.todo_pred_spoon = req.todo_pred_spoon;
          todo.todo_actual_spoon = req.todo_actual_spoon;
